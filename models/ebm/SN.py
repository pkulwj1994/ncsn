...
class SpectralNorm:
    ...
    def compute_weight(self, module: Module, do_power_iteration: bool) -> torch.Tensor:
        ...
        sigma = torch.dot(u, torch.mv(weight_mat, v)) + 1e-6
        weight = weight / sigma * torch.minimum(sigma, torch.ones_like(sigma))
        return weight
...
def spectral_norm_with_lower_bound(module: T_module,
                  name: str = 'weight',
...
def remove_spectral_norm_with_lower_bound(module: T_module, name: str = 'weight') -> T_module:
